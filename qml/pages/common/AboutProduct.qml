...
Dialog {
       ...
       text: "<b>"+"MyPeople version: "+root.appVersion+"  Author: fulvio"+"</b><br/><br/>"+
             "<b>"+i18n.tr("With MyPeople you can:")+"</b><br/>"
                  ...
                  +i18n.tr("Is not possible schedule a new meeting with a past date")+"<br/><br/>"
                  +i18n.tr("If current time is greater than the meeting one, meeting is 'SCHEDULED (EXPIRED)'.")+"<br/>"
