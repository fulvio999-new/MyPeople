...
UBUNTU_TRANSLATION_DOMAIN="mypeople.fulvius999"
...
aptest.commands = bash $$PWD/MyPeople/tests/autopilot/run
aptest.depends  = sub-MyPeople

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/MyPeople/tests/unit 
unittest.depends  = sub-MyPeople
